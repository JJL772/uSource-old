...
#include "engine/common/com_strings.h"
...
static inline void* Mem_Malloc( byte* pool, size_t size ) { return gEngfuncs._Mem_Alloc( pool, size, false, __FILE__, __LINE__ ); }
static inline void* Mem_Calloc( byte* pool, size_t size ) { return gEngfuncs._Mem_Alloc( pool, size, true, __FILE__, __LINE__ ); }
static inline void* Mem_Realloc( byte* pool, void* ptr, size_t size ) { return gEngfuncs._Mem_Realloc( pool, ptr, size, true, __FILE__, __LINE__ ); }
static inline void Mem_Free( void* mem ) { gEngfuncs._Mem_Free( mem, __FILE__, __LINE__ ); }
static inline void* Mem_AllocPool( const char* name ) { return gEngfuncs._Mem_AllocPool( name, __FILE__, __LINE__ ); }
static inline void Mem_FreePool( byte** pool ) { gEngfuncs._Mem_FreePool( pool, __FILE__, __LINE__ ); }
//static inline void Mem_EmptyPool( byte** pool ) { gEngfuncs._Mem_ }
